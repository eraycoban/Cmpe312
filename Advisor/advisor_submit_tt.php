...
<div class="main">
  ...
  <input type="hidden" id="default_periods" name="default_periods" value="<?php echo $default_p[0]["periods"];?>" >
          ...
          <div class="container mt-3"><center><button type="button" onclick="location.href='advisor.php'" class="submitButton btn btn-primary btn-lg " id="submit_btn" >Submit This Timetable</button></center></div>
