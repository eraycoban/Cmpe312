...
$third_info=$_POST;
$department_id=$third_info['department_id'];

$programs=$db->query("SELECT * FROM programs WHERE department_id=$department_id")->fetchAll(PDO::FETCH_ASSOC);
?>
<html>
<head>
...
<div class="main">
	...
	<form id="myForm" method="post" action="sa_new_user_show_up.php">
			 ...
			 <ul class="list-group offset-1 col-5 list-group-flush my-2">
                ...
                <li class="list-group-item">
				  <div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="<?php echo $programs[$i]["id"] ?>" name="program_id" value="<?php echo $programs[$i]["program_id"]; ?>">
		...
		<div class="form-group row">
				<div class="col-12">
				  <center><button name="submit" onclick="location.href='sa_new_user_department.php'"  type="button" class="btn btn-primary mx-1">Go Back</button><button id="myButton" name="submit" value="1" type="submit" class="btn btn-primary mx-1" disabled>Continue</button></center>
				</div>
		</div>
	</div>	
    </form>
...
<?php } else if(isset($_GET['user_role'])){ 
...
<div class="main">
	...
	<form id="myForm" method="get" action="sa_new_user_show_up.php">
